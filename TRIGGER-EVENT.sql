...
--- Trigger of CAM: Tạo trigger khi tiến hành cập nhật SoluongSP của bảng PRODUCT thì số lượng sản phẩm >= số lượng đặt hàng của bảng CHITIETHOADON
...
END
 ...
 -- Event OF CAM: Tạo 1 event cứ mỗi 15 ngày sẽ cập nhật lại  GiaSP của bảng PRODUCT 1 lần với GiaSP cố định là 2000 trên mỗi SP. 
